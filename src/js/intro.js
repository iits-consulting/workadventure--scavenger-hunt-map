...
var textThirdPopup = "Let's see if you can beat this game." +
    ...
    " If you solve the riddle access to the next level will be granted. Try to solve all 3 levels to get access to the jungle party ;) "
var targetObjectTutoBubble ='Tutobubble';
var targetObjectTutoChat ='tutoChat';
var targetObjectTutoExplanation ='tutoExplanation';
var targetObjectTutoExplanationBig = 'tutoGameExplain'
                ...
                WA.openPopup(targetObjectTutoChat, textSecondPopup, [
                    {
                        ...
                        callback: (popup1) => {
                            popup1.close();
                            WA.openPopup(targetObjectTutoExplanationBig, textThirdPopup, [
                                {
                                    label: "Next",
                                    className: "popUpElement",
                                    callback: (popup2) => {
